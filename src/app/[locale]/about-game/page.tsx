...
const About = () => {
  ...
  return (
    <div className={`${rubik.className} overflow-hidden text-light-2 flex-auto flex flex-col min-h-full common-container container-restrictive p-3 md:p-6 gap-5`}>
      ...
      <h2 className="text-2xl font-semibold text-shadow-neon text-primary-500 tracking-wide">{t("visionTitle")}</h2>
      <p className="leading-6 text-lg tracking-wide pb-3">{t("visionMessage")}</p>
      <h2 className="text-2xl font-semibold text-shadow-neon text-primary-500 tracking-wide">{t("featuresTitle")}</h2>
