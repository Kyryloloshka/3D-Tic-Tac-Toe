  ...
  return (
    <div className="overflow-hidden flex-auto flex flex-col min-h-full common-container p-3 md:p-6 gap-5 container-restrictive">
      ...
      <p className="leading-6 text-lg tracking-wide pt-8 pb-24 ">
        {t("enjoyMessage")} <Link href="/play-game" className={`link-underline hover:text-secondary-500 transition capitalize relative text-primary-500`}>{t("playGameLink")}</Link>
      </p>
    </div>
  )  
}
