...
const Header = () => {
  ...
  return (
    <header className="z-[500] top-0 sticky min-h-[60px] shadow-primary bg-dark-2 gap-3 flex justify-between items-center px-3 md:px-6 py-2 md:py-3">
      ...
      <Link draggable="false" href="/" className="text-primary-500 text-lg font-semibold text-shadow-neon whitespace-nowrap">3D Tic tac toe</Link>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent className="bg-dark-2 p-2 mr-3 md:mr-6 z-[501]">
